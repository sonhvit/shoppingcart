...
use Yii;
use common\models\store\ProductDescription;
use common\models\store\ProductDescriptionSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ProductController implements the CRUD actions for ProductDescription model.
 */
class ProductController extends Controller
{
    ...
    protected function findModel($id)
    {
        if (($model = ProductDescription::findOne($id)) !== null) {
            ...
            throw new NotFoundHttpException('The ProductDescription item does not exist.');
        }
    }
}
